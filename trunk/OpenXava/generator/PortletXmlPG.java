 ...
 * @version Tue Nov 14 11:14:41 CET 2006
 */
public class PortletXmlPG {
    ...
    out.print("\">\n\t\t<description>");
    out.print(Strings.toCharSet(application.getLabel(), "UTF-8"));
    out.print(" - ");
    out.print(Strings.toCharSet(module.getDescription(), "UTF-8"));
    ...
    out.print(locale);
    out.print("\">");
    out.print(Strings.toCharSet(application.getLabel(locale), "UTF-8"));
    out.print(" - ");
    out.print(Strings.toCharSet(module.getDescription(locale), "UTF-8"));
    out.print("</description>");
    } 
    out.print("       \n\t\t<portlet-name>");
    out.print(Strings.toCharSet(module.getName(), "UTF-8"));
    ...
    out.print(Strings.toCharSet(application.getLabel(), "UTF-8"));
    out.print(" - ");
    out.print(Strings.toCharSet(module.getLabel(), "UTF-8"));
    ...
    out.print(Strings.toCharSet(applicationName, "UTF-8"));
    out.print("</value>\n\t\t</init-param>\n\t\t<init-param>\n\t\t\t<name>Module</name>\n\t\t\t<value>");
    out.print(Strings.toCharSet(module.getName(), "UTF-8"));
    out.print("</value>\n\t\t</init-param>");
    } 
    ...
    public String[][] history = {
        { "Tue Nov 14 11:14:42 CET 2006", // date this file was generated
