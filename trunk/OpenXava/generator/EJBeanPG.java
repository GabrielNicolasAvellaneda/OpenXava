 ...
 * @version Mon Aug 06 18:23:29 CEST 2007
 */
...
private String generateFinderArgumentsByKey(MetaModel model) throws XavaException {
...
private String generateFinderArgumentsByKeyDeclaration(MetaModel model) throws XavaException {
	Iterator it = model.getAllKeyPropertiesNames().iterator();
	StringBuffer result = new StringBuffer();
	while (it.hasNext()) {		
...
private String generateEJBQLforReference(MetaModel model, String referenceName) throws XavaException {
    ...
    String jndi = metaModel.getMetaEJB().getJndi();
    String table = modelMapping.getTable();
    String keyClass = metaModel.getMetaEJB().getPrimaryKey();
    ...
    out.print(", EntityBean {\t\n\t\t\t\n\tprivate boolean creating = false;\t\t\n\tprivate boolean modified = false;\n\n\t// Create");
    	...
    	// For the aggregates
    	MetaModel containerModel = metaModel.getMetaModelContainer();
    	String containerName = containerModel.getName();
    	String containerClass = containerModel.getMetaEJB().getRemote();
    	String containerKeyClass = containerModel.getMetaEJB().getPrimaryKey();
    ...
    while (itCollections.hasNext()) {	
    	...
    	String referencedModelClass = referencedModel.getMetaEJB().getRemote();
    ...
    public String[][] history = {
        { "Mon Aug 06 18:23:30 CEST 2007", // date this file was generated
