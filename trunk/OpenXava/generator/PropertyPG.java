 ...
 * @version Wed Jun 01 09:36:45 CEST 2005
 */
...
private static void generate(XPathContext context, ProgramWriter out, MetaProperty property, boolean isPublic, boolean isEjb) throws XavaException {
    ...
    out.print("\").getMetaCalculator().getCalculator();");
    			...
    			while (itSets.hasNext()) {
    				...
    				if (propertyNameFrom.indexOf('.') >= 0) {
    					...
    					boolean isEmbededKey = ejb && (p.isKey() || p.getMetaModel() instanceof MetaAggregate);
    ...
    public String[][] history = {
        { "Wed Jun 01 09:36:45 CEST 2005", // date this file was generated
             "/home/javi/openxava/openxava-1.1/workspace/OpenXava/generator/property.xml", // input file
             "/home/javi/openxava/openxava-1.1/workspace/OpenXava/generator/PropertyPG.java" }, // output file
