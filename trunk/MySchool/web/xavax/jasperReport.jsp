...
<%@ page import="org.xavax.util.Primitives" %>
<%@ page import="org.xavax.util.Strings" %>
<%@ page import="org.xavax.util.Is" %>
<%@ page import="org.xavax.tab.meta.MetaTab" %>
...
XavaxComponent component = XavaxComponent.get(modelName);
...
%>
<fmt:setBundle basename="RecursosXava" scope="request"/>
