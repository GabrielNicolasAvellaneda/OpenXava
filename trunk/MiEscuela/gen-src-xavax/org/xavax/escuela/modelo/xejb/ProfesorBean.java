...
import org.xavax.escuela.modelo.*;


/**
 * @ejb:bean name="Profesor" type="CMP" jndi-name="@subcontext@/ejb/org.xavax.escuela.modelo/Profesor" reentrant="false" view-type="remote"
 * @ejb:interface extends="org.xavax.ejbx.EJBReplicable, org.xavax.escuela.modelo.IProfesor"
...
abstract public class ProfesorBean extends EJBReplicableBase 
			implements org.xavax.escuela.modelo.IProfesor, EntityBean {	
	 ...
	 * @ejb:create-method
	 */	 
	public org.xavax.escuela.modelo.ProfesorKey ejbCreate(Map values) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	 ...
	 * @ejb:create-method
	 */	 
	public org.xavax.escuela.modelo.ProfesorKey ejbCreate(org.xavax.escuela.modelo.ProfesorData data) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.xavax.escuela.modelo.ProfesorData data) 
		throws
			CreateException,
			ValidationException {			
	}
	 ...
	 * @ejb:create-method
	 */	 
	public org.xavax.escuela.modelo.ProfesorKey ejbCreate(org.xavax.escuela.modelo.ProfesorValue value) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.xavax.escuela.modelo.ProfesorValue value) 
		throws
			CreateException,
			ValidationException {			
	}
	 ...
	 * @ejb:interface-method
	 */	
	public abstract org.xavax.escuela.modelo.ProfesorData getData();		
	
	/**
	 * @ejb:interface-method
	 */		
	public abstract void setData(org.xavax.escuela.modelo.ProfesorData data);
	
	/**
	 * @ejb:interface-method
	 */	
	public abstract org.xavax.escuela.modelo.ProfesorValue getProfesorValue();		
	
	/**
	 * @ejb:interface-method
	 */		
	public abstract void setProfesorValue(org.xavax.escuela.modelo.ProfesorValue value);
