   ...
   implements java.io.Serializable
{
   ...
   public WorkerKey( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.WorkerKey) )
         return false;

      org.openxava.test.model.WorkerKey pk = (org.openxava.test.model.WorkerKey)obj;
      boolean eq = true;
    ...
    */
   public static WorkerKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
