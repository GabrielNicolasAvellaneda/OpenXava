 ...
 */
public abstract class ServiceTypeCMP
   extends org.openxava.test.model.xejb.ServiceTypeBean
   implements javax.ejb.EntityBean
{

   public org.openxava.test.model.ServiceTypeData getData()
   {
      org.openxava.test.model.ServiceTypeData dataHolder = null;
      try
      {
         dataHolder = new org.openxava.test.model.ServiceTypeData();
   ...
   public void setData( org.openxava.test.model.ServiceTypeData dataHolder )
   {
      try
      {
 ...
 /* Value Objects BEGIN */
   ...
   private org.openxava.test.model.ServiceTypeValue ServiceTypeValue = null;

   public org.openxava.test.model.ServiceTypeValue getServiceTypeValue()
   {
      ServiceTypeValue = new org.openxava.test.model.ServiceTypeValue();
      try
         {
   ...
   public void setServiceTypeValue( org.openxava.test.model.ServiceTypeValue valueHolder )
   {
