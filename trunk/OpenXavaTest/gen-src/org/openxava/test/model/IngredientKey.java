   ...
   implements java.io.Serializable
{
   ...
   public IngredientKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.IngredientKey) )
         return false;

      org.openxava.test.model.IngredientKey pk = (org.openxava.test.model.IngredientKey)obj;
      boolean eq = true;
    ...
    */
   public static IngredientKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
