 ...
 *
 */
public class TransportCharge2Value
   ...
   implements java.io.Serializable 
{
   ...
   public TransportCharge2Value()
   {
   }

   //TODO Cloneable is better than this !
   public TransportCharge2Value( TransportCharge2Value otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("amount=" + getAmount() + " " + "year=" + getYear() + " " + "delivery_number=" + getDelivery_number() + " " + "delivery_invoice_year=" + getDelivery_invoice_year() + " " + "delivery_invoice_number=" + getDelivery_invoice_number() + " " + "delivery_type_number=" + getDelivery_type_number());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof TransportCharge2Value)
	  {
		 TransportCharge2Value that = (TransportCharge2Value) other;
