   ...
   implements java.io.Serializable
{
   ...
   public IssueKey( java.lang.String id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.IssueKey) )
         return false;

      org.openxava.test.model.IssueKey pk = (org.openxava.test.model.IssueKey)obj;
      boolean eq = true;
    ...
    */
   public static IssueKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
