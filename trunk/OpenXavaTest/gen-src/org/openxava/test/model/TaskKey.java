   ...
   implements java.io.Serializable
{
   ...
   public TaskKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.TaskKey) )
         return false;

      org.openxava.test.model.TaskKey pk = (org.openxava.test.model.TaskKey)obj;
      boolean eq = true;
    ...
    */
   public static TaskKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
