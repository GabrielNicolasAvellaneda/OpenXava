   ...
   implements java.io.Serializable
{
   ...
   public ReportKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.ReportKey) )
         return false;

      org.openxava.test.model.ReportKey pk = (org.openxava.test.model.ReportKey)obj;
      boolean eq = true;
    ...
    */
   public static ReportKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
