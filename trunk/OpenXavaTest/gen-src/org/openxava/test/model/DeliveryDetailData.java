   ...
   implements java.io.Serializable
{
   ...
   public org.openxava.test.model.DeliveryDetailKey getPrimaryKey() {
     org.openxava.test.model.DeliveryDetailKey pk = new org.openxava.test.model.DeliveryDetailKey(this.getNumber());
     return pk;
   }
   ...
   public String toString()
   {
      ...
      str.append("_Description=" + get_Description() + " " + "number=" + getNumber() + " " + "_Delivery_number=" + get_Delivery_number() + " " + "_Delivery_invoice_year=" + get_Delivery_invoice_year() + " " + "_Delivery_invoice_number=" + get_Delivery_invoice_number() + " " + "_Delivery_type_number=" + get_Delivery_type_number());
      str.append('}');
