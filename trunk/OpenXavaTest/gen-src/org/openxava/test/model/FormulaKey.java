   ...
   implements java.io.Serializable
{
   ...
   public FormulaKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.FormulaKey) )
         return false;

      org.openxava.test.model.FormulaKey pk = (org.openxava.test.model.FormulaKey)obj;
      boolean eq = true;
    ...
    */
   public static FormulaKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
      StringTokenizer st = new StringTokenizer(string, "[.]");
      FormulaKey key = new FormulaKey();
