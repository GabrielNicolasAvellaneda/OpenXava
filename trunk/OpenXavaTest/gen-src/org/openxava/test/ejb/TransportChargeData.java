   ...
   implements java.io.Serializable
{
   ...
   public org.openxava.test.ejb.TransportChargeKey getPrimaryKey() {
     org.openxava.test.ejb.TransportChargeKey pk = new org.openxava.test.ejb.TransportChargeKey(this.get_Delivery_number(),this.get_Delivery_type_number(),this.get_Delivery_invoice_year(),this.get_Delivery_invoice_number());
     return pk;
   }
