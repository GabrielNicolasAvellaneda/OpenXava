   ...
   implements java.io.Serializable
{
   ...
   public org.openxava.test.ejb.WarehouseKey getPrimaryKey() {
     org.openxava.test.ejb.WarehouseKey pk = new org.openxava.test.ejb.WarehouseKey(this.get_Number(),this.getZoneNumber());
     return pk;
   }
