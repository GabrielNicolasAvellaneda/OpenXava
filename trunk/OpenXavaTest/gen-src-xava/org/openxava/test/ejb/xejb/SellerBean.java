 ...
 * 
 * @jboss:table-name "XAVATEST@separator@SELLER"
 *
...
abstract public class SellerBean extends EJBReplicableBase 
	...
	public void setBoss(org.openxava.test.ejb.Seller newBoss) { 
		...
		try {	
			...
			else setBossKey((org.openxava.test.ejb.SellerKey) newBoss.getPrimaryKey());
		}
		catch (Exception ex) {
			ex.printStackTrace();
	...
	private org.openxava.test.ejb.SellerHome bossHome;	
	private org.openxava.test.ejb.SellerHome getBossHome() throws Exception{
		if (bossHome == null) {
			bossHome = (org.openxava.test.ejb.SellerHome) PortableRemoteObject.narrow(
