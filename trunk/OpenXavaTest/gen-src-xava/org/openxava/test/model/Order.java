...
// File generated by OpenXava: Mon Oct 18 09:51:05 CEST 2010
// Archivo generado por OpenXava: Mon Oct 18 09:51:05 CEST 2010
...
public class Order implements java.io.Serializable, org.openxava.test.model.IOrder {	
	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Order findByOid(java.lang.String oid) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Order as o where o.oid = :arg0"); 
			query.setParameter("arg0", oid); 
 			...
 			org.hibernate.Query query = org.openxava.hibernate.XHibernate.getSession().createQuery("from Order as o where o.oid = :arg0"); 
			query.setParameter("arg0", oid); 
