...
public class Issue implements java.io.Serializable, org.openxava.test.model.IIssue {	
	...
	public java.util.Collection getCommentsWithCondition() throws RemoteException {
		if (XavaPreferences.getInstance().isJPAPersistence()) return getCommentsWithCondition_jpa();
		else return getCommentsWithCondition_hibernate();
	}
	...
	private java.util.Collection getCommentsWithCondition_jpa() throws RemoteException {
		javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Comment as o where o.issue.id = ?0");
		query.setParameter(0, getId()); 
