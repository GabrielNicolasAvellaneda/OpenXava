...
// File generated by OpenXava: Thu Jun 25 13:27:32 CEST 2015
// Archivo generado por OpenXava: Thu Jun 25 13:27:32 CEST 2015
...
public class Carrier implements java.io.Serializable, org.openxava.test.model.ICarrier {	
	...
	private java.util.Collection getFellowCarriers_jpa() throws RemoteException {
		javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Carrier as o where 				o.warehouse.zoneNumber = ?0 AND 				o.warehouse.number = ?1 AND 				NOT (o.number = ?2)			 order by o.number");
		query.setParameter(0, new Integer(getWarehouse().getZoneNumber()));
		query.setParameter(1, new Integer(getWarehouse().getNumber()));
		query.setParameter(2, get_Number()); 
