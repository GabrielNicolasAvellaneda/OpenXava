...
// File generated by OpenXava: Thu May 08 21:36:58 CEST 2014
// Archivo generado por OpenXava: Thu May 08 21:36:58 CEST 2014
	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Customer findByNumber(int number) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o where o.number = :arg0"); 
 	...
 	public static Collection findByNameLike(java.lang.String name)  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o where o.name like :arg0 order by o.name desc"); 
 	...
 	public static Collection findByNameLikeAndrelationWithSeller(java.lang.String name, java.lang.String relationWithSeller)  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o where o.name like :arg0 and relationWithSeller = :arg1 order by o.name desc"); 
			query.setParameter("arg0", name); 
 	...
 	public static Collection findNormalOnes()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o where o.type = 0"); 
 			return query.getResultList();  		
 		}
 		else {
 	...
 	public static Collection findSteadyOnes()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o where o.type = 1"); 
 			return query.getResultList();  		
 		}
 		else {
 	...
 	public static Collection findByStreet(java.lang.String street)  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o where o.address_street = :arg0"); 
 	...
 	public static Collection findOrderedByState()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o order by o.address_state.name"); 
 			return query.getResultList();  		
 		}
 		else {
 	...
 	public static Collection findAll()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Customer as o"); 
 			return query.getResultList();  		
 		}
 		else {
