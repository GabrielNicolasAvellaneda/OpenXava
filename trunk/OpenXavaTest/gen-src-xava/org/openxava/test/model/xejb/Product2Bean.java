 ...
 * @ejb:finder signature="Collection findByColor(java.lang.Integer number)" query="SELECT OBJECT(o) FROM Product2 o WHERE o._Color_number = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByColor(java.lang.Integer number)" query="SELECT OBJECT(o) FROM Product2 o WHERE o._Color_number = ?1 " 	
 ...
 * @ejb:finder signature="Collection findByFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM Product2 o WHERE o._Formula_oid = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM Product2 o WHERE o._Formula_oid = ?1 " 	
 ...
 * 
 * @jboss:table-name "XAVATEST.PRODUCT"
 *
...
abstract public class Product2Bean extends EJBReplicableBase 
	...
	private org.openxava.converters.IConverter getUnitPriceWithTaxConverter() {
		if (unitPriceWithTaxConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "unitPriceWithTax"));
			}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "UNITPRICE * 1.16"
	 */
	public abstract java.math.BigDecimal get_UnitPriceWithTax();
	public abstract void set_UnitPriceWithTax(java.math.BigDecimal newUnitPriceWithTax); 	
	...
	public java.math.BigDecimal getUnitPriceWithTax() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "UnitPriceWithTax", "Product2", "java.math.BigDecimal"));
		}
	}
	...
	// Color : Entity reference/Referencia a entidad
	...
	public org.openxava.test.model.IColor getColor() {
		try {		
			return getColorHome().findByPrimaryKey(getColorKey());
		}
		catch (ObjectNotFoundException ex) {
			return null;
		}
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("get_reference_error", "Color", "Product2"));
		}		
	}	
	...
	public org.openxava.test.model.ColorRemote getColorRemote() {
		return (org.openxava.test.model.ColorRemote) getColor();
	}
	...
	public void setColor(org.openxava.test.model.IColor newColor) { 
		this.modified = true; 
		try {	
			if (newColor == null) setColorKey(null);
			else {
				if (newColor instanceof org.openxava.test.model.Color) {
					throw new IllegalArgumentException(XavaResources.getString("pojo_to_ejb_illegal"));
				}
				org.openxava.test.model.ColorRemote remote = (org.openxava.test.model.ColorRemote) newColor;
				setColorKey((org.openxava.test.model.ColorKey) remote.getPrimaryKey());
			}	
		}
		catch (IllegalArgumentException ex) {
			throw ex;
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("set_reference_error", "Color", "Product2"));
		}
	}
	...
	public org.openxava.test.model.ColorKey getColorKey() {				
		org.openxava.test.model.ColorKey key = new org.openxava.test.model.ColorKey(); 
		key.number = getColor_number();		
		return key;
	}	
	...
	public void setColorKey(org.openxava.test.model.ColorKey key) { 
		this.modified = true; 		
		if (key == null) {
			key = new org.openxava.test.model.ColorKey(); 
			setColor_number(key.number);					
		}
		else { 
			setColor_number(key.number);		
		}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "COLOR_NUMBER"
	 */
	public abstract Integer get_Color_number();
	public abstract void set_Color_number(Integer newColor_number);
	...
	public void setColor_number(Integer newColor_number) { 
		set_Color_number(newColor_number); 	
	} 

	private org.openxava.test.model.ColorHome colorHome;	
	private org.openxava.test.model.ColorHome getColorHome() throws Exception{
		if (colorHome == null) {
			colorHome = (org.openxava.test.model.ColorHome) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.model/Color"),
			 		org.openxava.test.model.ColorHome.class);			 		
		}
		return colorHome;
	} 
	...
	public org.openxava.test.model.IFormula getFormula() {
		try {		
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("get_reference_error", "Formula", "Product2"));
		}		
	}	
	...
	public void setFormula(org.openxava.test.model.IFormula newFormula) { 
		...
		try {	
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("set_reference_error", "Formula", "Product2"));
		}
	}
