 ...
 * 	
 * @ejb:finder signature="Collection findByDeliveryPlace(java.lang.String oid)" query="SELECT OBJECT(o) FROM Receptionist o WHERE o._DeliveryPlace_oid = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByDeliveryPlace(java.lang.String oid)" query="SELECT OBJECT(o) FROM Receptionist o WHERE o._DeliveryPlace_oid = ?1 " 	
...
abstract public class ReceptionistBean extends EJBReplicableBase 
	 ...
	 */
	public abstract String get_DeliveryPlace_oid();
	public abstract void set_DeliveryPlace_oid(String newDeliveryPlace_oid);

	/**		
	 * @ejb:interface-method
	 * @ejb.value-object match="persistentCalculatedAndAggregate"
	 */
	public String getDeliveryPlace_oid() { 
		return get_DeliveryPlace_oid(); 
	}
	public void setDeliveryPlace_oid(String newDeliveryPlace_oid) { 
