...
// File generated by OpenXava: Tue Apr 15 17:29:08 CEST 2008
// Archivo generado por OpenXava: Tue Apr 15 17:29:08 CEST 2008
 ...
 * 	
 * @ejb:finder signature="Collection findByAlternateSeller(int number)" query="SELECT OBJECT(o) FROM Customer o WHERE o._AlternateSeller_number = ?1 ORDER BY o.number" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByAlternateSeller(int number)" query="SELECT OBJECT(o) FROM Customer o WHERE o._AlternateSeller_number = ?1 ORDER BY o.number" 	
 * @ejb:finder signature="Collection findBySeller(int number)" query="SELECT OBJECT(o) FROM Customer o WHERE o._Seller_number = ?1 ORDER BY o.number" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findBySeller(int number)" query="SELECT OBJECT(o) FROM Customer o WHERE o._Seller_number = ?1 ORDER BY o.number" 	
 ...
 * @ejb:finder signature="Collection findNormalOnes()" query="SELECT OBJECT(o) FROM Customer o WHERE o._Type = 0" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findNormalOnes()" query="SELECT OBJECT(o) FROM Customer o WHERE o._Type = 0" 	
 * @ejb:finder signature="Collection findSteadyOnes()" query="SELECT OBJECT(o) FROM Customer o WHERE o._Type = 1" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findSteadyOnes()" query="SELECT OBJECT(o) FROM Customer o WHERE o._Type = 1" 	
 ...
 * 
 * @jboss:table-name "XAVATEST.CUSTOMER"
 *
...
abstract public class CustomerBean extends EJBReplicableBase 
	...
	private org.openxava.converters.IConverter getWebsiteConverter() {
		if (websiteConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "website"));
			}
	 ...
	 * 
	 * @jboss:column-name "WEBSITE"
	 */
	public abstract java.lang.String get_Website();
	public abstract void set_Website(java.lang.String newWebsite); 	
	...
	public String getWebsite() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "Website", "Customer", "String"));
		}
	}
	...
	private org.openxava.converters.IConverter getEmailConverter() {
		if (emailConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "email"));
			}
	...
	public abstract void set_Email(java.lang.String newEmail); 	
	...
	public String getEmail() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "Email", "Customer", "String"));
		}
	}
	...
	private org.openxava.converters.IConverter getTelephoneConverter() {
		if (telephoneConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "telephone"));
			}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "TELEPHONE"
	 */
	public abstract java.lang.String get_Telephone();
	public abstract void set_Telephone(java.lang.String newTelephone); 	
	...
	public String getTelephone() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "Telephone", "Customer", "String"));
		}
	}
	...
	private org.openxava.test.model.CustomerStateHome statesHome; 
	/**
	 * @ejb:interface-method
	 */
	public java.util.Collection getStates() {		
		try {
			return getStatesHome().findByCustomer(getNumber());
		}
		catch (Exception ex) {
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("get_collection_elements_error", "States", "Customer"));
		}
	}
		
	private org.openxava.test.model.CustomerStateHome getStatesHome() throws Exception{
		if (statesHome == null) {
			statesHome = (org.openxava.test.model.CustomerStateHome) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.model/CustomerState"),
			 		org.openxava.test.model.CustomerStateHome.class);			 		
		}
		return statesHome;
	}		
	...
	private int getAddress_customer_number() {
		return getNumber();
	} 
	...
	public String getAddress_asString() { 
		...
		try {			
			...
			address_asStringCalculator.setInt5(getAddress_customer_number()); 
	...
	public abstract void set_AlternateSeller_number(java.lang.Integer newAlternateSeller_number);
	...
	public int getAlternateSeller_number() { 
		try {
			return ((Integer) alternateSeller_numberConverter.toJava(get_AlternateSeller_number())).intValue();
		}
		catch (org.openxava.converters.ConversionException ex) {
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "alternateSeller.number", "Customer", "int"));
		} 
	}
	public void setAlternateSeller_number(int newAlternateSeller_number) { 
		try {
			set_AlternateSeller_number((java.lang.Integer) alternateSeller_numberConverter.toDB(new Integer(newAlternateSeller_number)));
		}
		catch (org.openxava.converters.ConversionException ex) {
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "alternateSeller.number", "Customer", "int"));
	...
	private static final org.openxava.converters.IntegerNumberConverter 
		alternateSeller_numberConverter =
			new org.openxava.converters.IntegerNumberConverter(); 
	...
	public abstract void set_Seller_number(java.lang.Integer newSeller_number);
	...
	public int getSeller_number() { 
		try {
			return ((Integer) seller_numberConverter.toJava(get_Seller_number())).intValue();
		}
		catch (org.openxava.converters.ConversionException ex) {
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "seller.number", "Customer", "int"));
		} 
	}
	public void setSeller_number(int newSeller_number) { 
		try {
			set_Seller_number((java.lang.Integer) seller_numberConverter.toDB(new Integer(newSeller_number)));
		}
		catch (org.openxava.converters.ConversionException ex) {
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "seller.number", "Customer", "int"));
