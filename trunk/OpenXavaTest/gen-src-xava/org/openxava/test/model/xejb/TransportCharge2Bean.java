 ...
 * 	
 * @ejb:finder signature="Collection findByDelivery(int number, int type_number, int invoice_year, int invoice_number)" query="SELECT OBJECT(o) FROM TransportCharge2 o WHERE o._Delivery_number = ?1 AND o._Delivery_type_number = ?2 AND o.year = ?3 AND o._Delivery_invoice_number = ?4 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByDelivery(int number, int type_number, int invoice_year, int invoice_number)" query="SELECT OBJECT(o) FROM TransportCharge2 o WHERE o._Delivery_number = ?1 AND o._Delivery_type_number = ?2 AND o.year = ?3 AND o._Delivery_invoice_number = ?4 " 	
