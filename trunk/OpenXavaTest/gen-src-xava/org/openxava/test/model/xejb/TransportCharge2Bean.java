 ...
 * 	
 * @ejb:finder signature="Collection findByDelivery(int invoice_year, int invoice_number, int type_number, int number)" query="SELECT OBJECT(o) FROM TransportCharge2 o WHERE o.year = ?1 AND o._Delivery_invoice_number = ?2 AND o._Delivery_type_number = ?3 AND o._Delivery_number = ?4 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByDelivery(int invoice_year, int invoice_number, int type_number, int number)" query="SELECT OBJECT(o) FROM TransportCharge2 o WHERE o.year = ?1 AND o._Delivery_invoice_number = ?2 AND o._Delivery_type_number = ?3 AND o._Delivery_number = ?4 " 	
