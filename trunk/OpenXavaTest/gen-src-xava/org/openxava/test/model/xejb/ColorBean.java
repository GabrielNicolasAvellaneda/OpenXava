 ...
 * 	
 * @ejb:finder signature="Color findByNumber(int number)" query="SELECT OBJECT(o) FROM Color o WHERE o.number = ?1" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Color findByNumber(int number)" query="SELECT OBJECT(o) FROM Color o WHERE o.number = ?1" 
 * 
