 ...
 * 	
 * @ejb:finder signature="Collection findAll()" query="SELECT OBJECT(o) FROM Color o" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findAll()" query="SELECT OBJECT(o) FROM Color o" 	
...
abstract public class ColorBean extends EJBReplicableBase 
	...
	private org.openxava.converters.IConverter getHexValueConverter() {
		if (hexValueConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "hexValue"));
			}
	 ...
	 * 
	 * @jboss:column-name "HEXVALUE"
	 */
	public abstract java.lang.String get_HexValue();
	public abstract void set_HexValue(java.lang.String newHexValue); 	
	...
	public String getHexValue() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "HexValue", "Color", "String"));
		}
	}
	...
	private org.openxava.converters.IConverter getVersionConverter() {
		if (versionConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "version"));
			}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "VERSION"
	 */
	public abstract java.lang.Integer get_Version();
	public abstract void set_Version(java.lang.Integer newVersion); 	
	...
	public int getVersion() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "Version", "Color", "int"));
		}
	}
