 ...
 * 	
 * @ejb:finder signature="Collection findByLevel(java.lang.String id)" query="SELECT OBJECT(o) FROM Seller o WHERE o._Level_id = ?1 ORDER BY o.number" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByLevel(java.lang.String id)" query="SELECT OBJECT(o) FROM Seller o WHERE o._Level_id = ?1 ORDER BY o.number" 	
 * @ejb:finder signature="Collection findByBoss(int number)" query="SELECT OBJECT(o) FROM Seller o WHERE o._Boss_number = ?1 ORDER BY o.number" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByBoss(int number)" query="SELECT OBJECT(o) FROM Seller o WHERE o._Boss_number = ?1 ORDER BY o.number" 	
 ...
 * 
 * @jboss:table-name "XAVATEST.SELLER"
 *
