...
abstract public class InvoiceBean extends EJBReplicableBase 
	...
	public java.math.BigDecimal getSellerDiscount() {
		try { 		
			...
			sellerDiscountCalculator.setSellerNumber(getCustomerRemote().getSeller_number()); 
	...
	public void addToDeliveries(org.openxava.test.model.DeliveryRemote newElement) {
		if (newElement != null) { 
			try {
				newElement.setInvoiceKey((org.openxava.test.model.InvoiceKey) getEntityContext().getPrimaryKey());
			}
			catch (Exception ex) {
				ex.printStackTrace();
