...
// File generated by OpenXava: Wed Jun 04 12:16:07 CEST 2008
// Archivo generado por OpenXava: Wed Jun 04 12:16:07 CEST 2008
...
abstract public class InvoiceDetail2Bean extends EJBReplicableBase 
	...
	public org.openxava.test.model.Product2Remote getProductRemote() {
		return (org.openxava.test.model.Product2Remote) getProduct();
	}
	...
	public void setProduct(org.openxava.test.model.IProduct2 newProduct) { 
		...
		try {	
			if (newProduct == null) setProductKey(null);
				...
				if (newProduct instanceof org.openxava.test.model.Product2) {
					throw new IllegalArgumentException(XavaResources.getString("pojo_to_ejb_illegal"));
				}
				org.openxava.test.model.Product2Remote remote = (org.openxava.test.model.Product2Remote) newProduct;
				setProductKey((org.openxava.test.model.Product2Key) remote.getPrimaryKey());
			}	
		}
	...
	public org.openxava.test.model.Product2Key getProductKey() {				
		org.openxava.test.model.Product2Key key = new org.openxava.test.model.Product2Key(); 
	...
	public void setProductKey(org.openxava.test.model.Product2Key key) { 
		this.modified = true; 		
		if (key == null) {
			key = new org.openxava.test.model.Product2Key(); 
	...
	private org.openxava.test.model.Product2Home productHome;	
	private org.openxava.test.model.Product2Home getProductHome() throws Exception{
		if (productHome == null) {
			productHome = (org.openxava.test.model.Product2Home) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.model/Product2"),
			 		org.openxava.test.model.Product2Home.class);			 		
		}
		return productHome;
	} 
