...
// File generated by OpenXava: Thu Apr 20 13:41:32 CEST 2006
// Archivo generado por OpenXava: Thu Apr 20 13:41:32 CEST 2006
 ...
 * 	
 * @ejb:finder signature="Collection findByOfficeManager(int zoneNumber, int officeNumber, int number)" query="SELECT OBJECT(o) FROM Office2 o WHERE o.zoneNumber = ?1 AND o.number = ?2 AND o._OfficeManager_number = ?3 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByOfficeManager(int zoneNumber, int officeNumber, int number)" query="SELECT OBJECT(o) FROM Office2 o WHERE o.zoneNumber = ?1 AND o.number = ?2 AND o._OfficeManager_number = ?3 " 	
 ...
 * @ejb:finder signature="Collection findByMainWarehouse(int zoneNumber, java.lang.Integer number)" query="SELECT OBJECT(o) FROM Office2 o WHERE o.zoneNumber = ?1 AND o._MainWarehouse_number = ?2 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByMainWarehouse(int zoneNumber, java.lang.Integer number)" query="SELECT OBJECT(o) FROM Office2 o WHERE o.zoneNumber = ?1 AND o._MainWarehouse_number = ?2 " 
 * 
