...
abstract public class Invoice2Bean extends EJBReplicableBase 
	...
	private org.openxava.converters.IConverter getAmountsSumConverter() {
		if (amountsSumConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "amountsSum"));
			}
	 ...
	 * 
	 * @jboss:column-name "AMOUNTSSUM"
	 */
	public abstract java.math.BigDecimal get_AmountsSum();
	public abstract void set_AmountsSum(java.math.BigDecimal newAmountsSum); 	
	...
	public java.math.BigDecimal getAmountsSum() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "AmountsSum", "Invoice2", "java.math.BigDecimal"));
		}
	}
