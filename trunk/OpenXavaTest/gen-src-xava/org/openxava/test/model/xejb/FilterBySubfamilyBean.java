 ...
 * 	
 * @ejb:finder signature="Collection findBySubfamilyTo(int number)" query="SELECT OBJECT(o) FROM FilterBySubfamily o WHERE o._SubfamilyTo_number = ?1 ORDER BY o.oid" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findBySubfamilyTo(int number)" query="SELECT OBJECT(o) FROM FilterBySubfamily o WHERE o._SubfamilyTo_number = ?1 ORDER BY o.oid" 	
 * @ejb:finder signature="Collection findBySubfamily(int number)" query="SELECT OBJECT(o) FROM FilterBySubfamily o WHERE o._Subfamily_number = ?1 ORDER BY o.oid" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findBySubfamily(int number)" query="SELECT OBJECT(o) FROM FilterBySubfamily o WHERE o._Subfamily_number = ?1 ORDER BY o.oid" 	
 * @ejb:finder signature="FilterBySubfamily findByOid(java.lang.String oid)" query="SELECT OBJECT(o) FROM FilterBySubfamily o WHERE o.oid = ?1" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="FilterBySubfamily findByOid(java.lang.String oid)" query="SELECT OBJECT(o) FROM FilterBySubfamily o WHERE o.oid = ?1" 
 * 
...
abstract public class FilterBySubfamilyBean extends EJBReplicableBase 
			implements org.openxava.test.model.IFilterBySubfamily, EntityBean {	
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.model.FilterBySubfamilyKey ejbCreate(Map values) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.model.FilterBySubfamilyKey ejbCreate(org.openxava.test.model.FilterBySubfamilyData data) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.openxava.test.model.FilterBySubfamilyData data) 
		throws
			CreateException,
			ValidationException { 			
	}
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.model.FilterBySubfamilyKey ejbCreate(org.openxava.test.model.FilterBySubfamilyValue value) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.openxava.test.model.FilterBySubfamilyValue value) 
		throws
			CreateException,
			ValidationException { 			
	}
	...
	private org.openxava.test.model.Subfamily2Home getSubfamilyToHome() throws Exception{
		if (subfamilyToHome == null) {
			subfamilyToHome = (org.openxava.test.model.Subfamily2Home) PortableRemoteObject.narrow(
