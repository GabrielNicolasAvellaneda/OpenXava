	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static ConversionFactor findById(java.lang.Long id) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from ConversionFactor as o where o.id = :arg0"); 
			query.setParameter("arg0", id); 
 			try {
				return (ConversionFactor) query.getSingleResult();
			}
			catch (Exception ex) {
