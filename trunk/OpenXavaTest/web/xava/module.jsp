...
%> 	
	<link href="<%=contextPath%>/xava/style/c3.min.css?ox=<%=version%>" rel="stylesheet" type="text/css">
	...
	<script type='text/javascript' src='<%=contextPath%>/xava/js/d3.min.js?ox=<%=version%>'></script> 
	<script type='text/javascript' src='<%=contextPath%>/xava/js/c3.min.js?ox=<%=version%>'></script> 
	<%
