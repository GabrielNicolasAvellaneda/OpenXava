 ...
 * @version Wed Jun 01 09:36:47 CEST 2005
 */
...
private String generateEJBQLforReference(IMetaModel model, String referenceName) throws XavaException {
    ...
    while (itReferences.hasNext()) {	
    	...
    	if (reference.getMetaModelReferenced() instanceof MetaAggregateBean) {	
    		AggregateReferencePG.generate(context, out, reference);
    	} 
    	else { // reference to entity or aggreate implemented as EJB
    		EntityReferencePG.generate(context, out, reference);
    	}
    } 
    ...
    out.print(" \n\t\t}\n\t\tcatch (Exception ex) {\n\t\t\tex.printStackTrace();\n\t\t\tthrow new EJBException(XavaResources.getString(\"method_execution_error\", \"");
    out.print(method.getName());
    out.print("\", \"");
    out.print(name);
    out.print("\"));\n\t\t}\n\t}");
    ...
    public String[][] history = {
        { "Wed Jun 01 09:36:48 CEST 2005", // date this file was generated
             "/home/javi/openxava/openxava-1.1/workspace/OpenXava/generator/ejbean.xml", // input file
             "/home/javi/openxava/openxava-1.1/workspace/OpenXava/generator/EJBeanPG.java" }, // output file
