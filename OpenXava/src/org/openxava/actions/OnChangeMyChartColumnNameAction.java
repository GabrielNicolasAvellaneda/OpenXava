...
public class OnChangeMyChartColumnNameAction extends OnChangeMyReportColumnBaseAction { 
	...
	public void execute() throws Exception {
		...
		MyChartColumn column = (MyChartColumn) getView().getModel();
		...
		if (!Is.emptyString(descriptionsListEditorURL)) {
			getView().putObject("xava.myChartColumnDescriptionsListEditorURL", descriptionsListEditorURL); 
