...
import org.openxava.actions.OnChangeMyChartColumnNameAction;
 ...
 *
 */
public class MyChartColumn implements Serializable {
	...
	@OnChange(OnChangeMyChartColumnNameAction.class)
	@Required
	private String name;
	...
	public void setChart(MyChart report) {
		this.chart = report;
	}
