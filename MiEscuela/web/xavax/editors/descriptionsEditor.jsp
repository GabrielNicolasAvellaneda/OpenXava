...
<%@ page import="org.xavax.util.KeyAndDescription" %>
<%@ page import="org.xavax.util.Is" %>
<%@ page import="org.xavax.util.XavaxResources" %>
<%@ page import="org.xavax.model.meta.MetaProperty" %>
<%@ page import="org.xavax.model.meta.MetaEjbImpl" %>
<%@ page import="org.xavax.calculators.DescriptionsCalculator" %>
<%@ page import="org.xavax.formatters.IFormatter" %>
<%@ page import="org.xavax.filters.IFilter" %>
<%@ page import="org.xavax.filters.IRequestFilter" %>
...
if (filterClass != null) {
	...
	if (filter == null) {
		try {
			...
			ex.printStackTrace();
			System.err.println(XavaxResources.getString("descriptionsEditor_filter_warning", propertyKey));
		}
	}
...
if (descriptionsFormatterClass != null) {
	...
	if (formatter == null) {
		try {
			...
			ex.printStackTrace();
			System.err.println(XavaxResources.getString("descriptionsEditor_descriptions_formatter_warning", propertyKey));
		}
	}
}
...
boolean label = org.xavax.util.XavaxPreferences.getInstance().isReadOnlyAsLabel() || "true".equalsIgnoreCase(request.getParameter("readOnlyAsLabel"));
if (editable) { 
%>
