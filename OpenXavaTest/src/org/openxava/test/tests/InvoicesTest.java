...
public class InvoicesTest extends ModuleTestBase {
	...
	public void testCustomizeList_addColumns() throws Exception {
		...
		assertValueInCollection("xavaPropertiesList", 12, 1, "customer.relationWithSeller");
		assertValueInCollection("xavaPropertiesList", 13, 1, "customer.seller.number");
		assertValueInCollection("xavaPropertiesList", 14, 1, "customer.seller.name");
		assertValueInCollection("xavaPropertiesList", 15, 1, "customer.seller.level.id");
		assertValueInCollection("xavaPropertiesList", 16, 1, "customer.seller.level.description");
		assertValueInCollection("xavaPropertiesList", 17, 1, "customer.alternateSeller.number");
		assertValueInCollection("xavaPropertiesList", 18, 1, "customer.alternateSeller.name");
		assertValueInCollection("xavaPropertiesList", 19, 1, "customer.alternateSeller.level.id");
		assertValueInCollection("xavaPropertiesList", 20, 1, "customer.alternateSeller.level.description");		
		assertValueInCollection("xavaPropertiesList", 21, 1, "customer.address.street");
		assertValueInCollection("xavaPropertiesList", 22, 1, "customer.address.zipCode");
		assertValueInCollection("xavaPropertiesList", 23, 1, "customer.address.city");
		assertValueInCollection("xavaPropertiesList", 24, 1, "customer.address.state.id");
		assertValueInCollection("xavaPropertiesList", 25, 1, "customer.address.state.name");		
		assertValueInCollection("xavaPropertiesList", 26, 1, "customer.address.state.fullName");
		...
		assertValueInCollection("xavaPropertiesList", 11, 1, "customer.relationWithSeller");
		assertValueInCollection("xavaPropertiesList", 12, 1, "customer.seller.number");
		assertValueInCollection("xavaPropertiesList", 13, 1, "customer.seller.name");
		assertValueInCollection("xavaPropertiesList", 14, 1, "customer.seller.level.id");
		assertValueInCollection("xavaPropertiesList", 15, 1, "customer.seller.level.description");
		assertValueInCollection("xavaPropertiesList", 16, 1, "customer.alternateSeller.number");
		assertValueInCollection("xavaPropertiesList", 17, 1, "customer.alternateSeller.name");
		assertValueInCollection("xavaPropertiesList", 18, 1, "customer.alternateSeller.level.id");
		assertValueInCollection("xavaPropertiesList", 19, 1, "customer.alternateSeller.level.description");					
		assertValueInCollection("xavaPropertiesList", 20, 1, "customer.address.street");
		assertValueInCollection("xavaPropertiesList", 21, 1, "customer.address.zipCode");
		assertValueInCollection("xavaPropertiesList", 22, 1, "customer.address.state.id");		
		assertValueInCollection("xavaPropertiesList", 23, 1, "customer.address.state.name");
		assertValueInCollection("xavaPropertiesList", 24, 1, "customer.address.state.fullName");
