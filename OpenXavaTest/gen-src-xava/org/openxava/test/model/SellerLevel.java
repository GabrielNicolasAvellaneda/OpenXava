	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static SellerLevel findById(java.lang.String id) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from SellerLevel as o where o.id = :arg0"); 
			query.setParameter("arg0", id); 
 			try {
				return (SellerLevel) query.getSingleResult();
			}
			catch (Exception ex) {
