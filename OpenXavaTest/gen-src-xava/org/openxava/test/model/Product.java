...
public class Product implements java.io.Serializable, org.openxava.test.model.IProduct {	
	...
	public BigDecimal getUnitPriceInPesetas() { 		
		try {			
			...
			return (BigDecimal) unitPriceInPesetasCalculator.calculate();
		}
	...
	public void setUnitPriceInPesetas(BigDecimal newUnitPriceInPesetas) {
	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Collection findAll()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Product as o where 1 = 1"); 
 	...
 	public static Product findByNumber(long number) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Product as o where o.number = :arg0"); 
