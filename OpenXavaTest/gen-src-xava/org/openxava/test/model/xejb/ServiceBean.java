 ...
 * 	
 * @ejb:finder signature="Collection findByInvoice(java.lang.String oid)" query="SELECT OBJECT(o) FROM Service o WHERE o._Invoice_oid = ?1 ORDER BY o.number" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByInvoice(java.lang.String oid)" query="SELECT OBJECT(o) FROM Service o WHERE o._Invoice_oid = ?1 ORDER BY o.number" 	
 ...
 * 
 * @jboss:table-name "XAVATEST.SERVICE"
 *
...
abstract public class ServiceBean extends EJBReplicableBase 
	...
	public org.openxava.test.model.IServiceInvoice getInvoice() {
		try {		
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("get_reference_error", "Invoice", "Service"));
		}		
	}	
	...
	public org.openxava.test.model.ServiceInvoiceRemote getInvoiceRemote() {
		return (org.openxava.test.model.ServiceInvoiceRemote) getInvoice();
	}
	...
	public void setInvoice(org.openxava.test.model.IServiceInvoice newInvoice) { 
		...
		try {	
			if (newInvoice == null) setInvoiceKey(null);
				...
				if (newInvoice instanceof org.openxava.test.model.ServiceInvoice) {
					throw new IllegalArgumentException(XavaResources.getString("pojo_to_ejb_illegal"));
				}
				org.openxava.test.model.ServiceInvoiceRemote remote = (org.openxava.test.model.ServiceInvoiceRemote) newInvoice;
				setInvoiceKey((org.openxava.test.model.ServiceInvoiceKey) remote.getPrimaryKey());
			}	
		}
		catch (IllegalArgumentException ex) {
			throw ex;
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("set_reference_error", "Invoice", "Service"));
		}
	}
	...
	public org.openxava.test.model.ServiceInvoiceKey getInvoiceKey() {				
		org.openxava.test.model.ServiceInvoiceKey key = new org.openxava.test.model.ServiceInvoiceKey(); 
		key.oid = getInvoice_oid();		
		return key;
	}	
	...
	public void setInvoiceKey(org.openxava.test.model.ServiceInvoiceKey key) { 
		this.modified = true; 		
		if (key == null) {
			key = new org.openxava.test.model.ServiceInvoiceKey(); 
			setInvoice_oid(key.oid);					
		}
		else { 
			setInvoice_oid(key.oid);		
		}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "INVOICE_OID"
	 */
	public abstract String get_Invoice_oid();
	public abstract void set_Invoice_oid(String newInvoice_oid);

	/**		
	 * @ejb:interface-method
	 * @ejb.value-object match="persistentCalculatedAndAggregate"
	 */
	public String getInvoice_oid() { 
		return get_Invoice_oid(); 
	}
	public void setInvoice_oid(String newInvoice_oid) { 
		set_Invoice_oid(newInvoice_oid); 	
	} 

	private org.openxava.test.model.ServiceInvoiceHome invoiceHome;	
	private org.openxava.test.model.ServiceInvoiceHome getInvoiceHome() throws Exception{
		if (invoiceHome == null) {
			invoiceHome = (org.openxava.test.model.ServiceInvoiceHome) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.model/ServiceInvoice"),
			 		org.openxava.test.model.ServiceInvoiceHome.class);			 		
		}
		return invoiceHome;
	} 
