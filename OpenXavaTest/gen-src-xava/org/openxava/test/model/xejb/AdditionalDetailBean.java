 ...
 * 	
 * @ejb:finder signature="Collection findByService(int number)" query="SELECT OBJECT(o) FROM AdditionalDetail o WHERE o._Service_number = ?1 ORDER BY o.counter" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByService(int number)" query="SELECT OBJECT(o) FROM AdditionalDetail o WHERE o._Service_number = ?1 ORDER BY o.counter" 	
 * @ejb:finder signature="Collection findByType(int number)" query="SELECT OBJECT(o) FROM AdditionalDetail o WHERE o._Type_number = ?1 ORDER BY o.counter" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByType(int number)" query="SELECT OBJECT(o) FROM AdditionalDetail o WHERE o._Type_number = ?1 ORDER BY o.counter" 
 * 
 * @jboss:table-name "XAVATEST.SERVICEDETAIL"
 *
...
abstract public class AdditionalDetailBean extends EJBReplicableBase 
	...
	public org.openxava.test.model.AdditionalDetailKey ejbCreate(org.openxava.test.model.ServiceRemote container, int counter, Map values) 
		...
		try { 	
			org.openxava.calculators.CounterByPassOidCalculator counterCalculator = (org.openxava.calculators.CounterByPassOidCalculator)
				getMetaModel().getMetaProperty("counter").getMetaCalculatorDefaultValue().createCalculator(); 
			counterCalculator.setContainer(container);
	...
	public org.openxava.test.model.AdditionalDetailKey ejbCreate(org.openxava.test.model.ServiceKey containerKey, int counter, Map values)	
		...
		try { 	
			org.openxava.calculators.CounterByPassOidCalculator counterCalculator = (org.openxava.calculators.CounterByPassOidCalculator)
				getMetaModel().getMetaProperty("counter").getMetaCalculatorDefaultValue().createCalculator(); 
			Object container = ServiceUtil.getHome().findByPrimaryKey(containerKey);
			counterCalculator.setContainer(container);
			counterCalculator.setCounter(counter); 
			setCounter(((Integer) counterCalculator.calculate()).intValue()); 
		}
	...
	public void setService(org.openxava.test.model.IService newService) { 
		...
		try {	
			if (newService == null) setServiceKey(null);
				...
				if (newService instanceof org.openxava.test.model.Service) {
	...
	public void setType(org.openxava.test.model.IServiceType newType) { 
		...
		try {	
			if (newType == null) setTypeKey(null);
				...
				if (newType instanceof org.openxava.test.model.ServiceType) {
					throw new IllegalArgumentException(XavaResources.getString("pojo_to_ejb_illegal"));
				}
