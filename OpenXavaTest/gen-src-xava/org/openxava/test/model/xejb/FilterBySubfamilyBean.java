...
abstract public class FilterBySubfamilyBean extends EJBReplicableBase 
	...
	public String getRangeDescription() { 
		...
		try {			
			...
			rangeDescriptionCalculator.setSubfamilyNumberFrom(getSubfamily_number());  	
			
			rangeDescriptionCalculator.setSubfamilyNumberTo(getSubfamilyTo_number()); 
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.calculate_value_error", "RangeDescription", "FilterBySubfamily", ex.getLocalizedMessage()));
		} 
		finally {
			if (cmtActivated) {
