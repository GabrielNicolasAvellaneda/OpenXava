 ...
 * 
 * @jboss:table-name "XAVATEST.FORMULAINGREDIENT"
 *
...
abstract public class FormulaIngredientBean extends EJBReplicableBase 
	...
	private org.openxava.converters.IConverter getImageConverter() {
		if (imageConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "image"));
			}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "IMAGE"
	 */
	public abstract byte[] get_Image();
	public abstract void set_Image(byte[] newImage); 	
	...
	public byte[] getImage() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "Image", "FormulaIngredient", "byte[]"));
		}
	}
