...
// File generated by OpenXava: Wed May 17 12:00:50 CEST 2006
// Archivo generado por OpenXava: Wed May 17 12:00:50 CEST 2006
 ...
 * 	
 * @ejb:finder signature="Collection findByIngredient(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._Ingredient_oid = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByIngredient(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._Ingredient_oid = ?1 " 	
 * @ejb:finder signature="Collection findByAccentuate(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._Accentuate_oid = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByAccentuate(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._Accentuate_oid = ?1 " 	
 * @ejb:finder signature="Collection findByAnotherFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._AnotherFormula_oid = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByAnotherFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._AnotherFormula_oid = ?1 " 	
 * @ejb:finder signature="Collection findByFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._Formula_oid = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM FormulaIngredient o WHERE o._Formula_oid = ?1 " 
 * 
