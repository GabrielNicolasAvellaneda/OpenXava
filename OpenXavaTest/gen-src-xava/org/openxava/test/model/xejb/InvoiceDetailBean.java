...
// File generated by OpenXava: Thu Feb 23 09:23:35 CET 2006
// Archivo generado por OpenXava: Thu Feb 23 09:23:35 CET 2006
 ...
 * 	
 * @ejb:finder signature="Collection findByProduct(long number)" query="SELECT OBJECT(o) FROM InvoiceDetail o WHERE o._Product_number = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByProduct(long number)" query="SELECT OBJECT(o) FROM InvoiceDetail o WHERE o._Product_number = ?1 " 	
 * @ejb:finder signature="Collection findBySoldBy(int number)" query="SELECT OBJECT(o) FROM InvoiceDetail o WHERE o._SoldBy_number = ?1 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findBySoldBy(int number)" query="SELECT OBJECT(o) FROM InvoiceDetail o WHERE o._SoldBy_number = ?1 " 	
 ...
 * 
 * @jboss:table-name "XAVATEST@separator@INVOICEDETAIL"
 *
...
abstract public class InvoiceDetailBean extends EJBReplicableBase 
	...
	private org.openxava.converters.IConverter quantityConverter;
	...
	private org.openxava.converters.IConverter serviceTypeConverter;
