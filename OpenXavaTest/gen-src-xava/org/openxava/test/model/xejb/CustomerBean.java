 ...
 * @ejb:finder signature="Collection findOrderedByState()" query="SELECT OBJECT(o) FROM Customer o ORDER BY o._Address_state_name" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findOrderedByState()" query="SELECT OBJECT(o) FROM Customer o ORDER BY o._Address_state_name" 	
