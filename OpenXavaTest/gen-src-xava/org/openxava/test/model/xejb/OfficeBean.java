 ...
 * 	
 * @ejb:finder signature="Collection findByOfficeManager(int zoneNumber, int officeNumber, int number)" query="SELECT OBJECT(o) FROM Office o WHERE o._ZoneNumber = ?1 AND o.number = ?2 AND o._OfficeManager_number = ?3 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByOfficeManager(int zoneNumber, int officeNumber, int number)" query="SELECT OBJECT(o) FROM Office o WHERE o._ZoneNumber = ?1 AND o.number = ?2 AND o._OfficeManager_number = ?3 " 	
 ...
 * @ejb:finder signature="Collection findByMainWarehouse(int zoneNumber, java.lang.Integer number)" query="SELECT OBJECT(o) FROM Office o WHERE o._ZoneNumber = ?1 AND o._MainWarehouse_number = ?2 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByMainWarehouse(int zoneNumber, java.lang.Integer number)" query="SELECT OBJECT(o) FROM Office o WHERE o._ZoneNumber = ?1 AND o._MainWarehouse_number = ?2 " 	
