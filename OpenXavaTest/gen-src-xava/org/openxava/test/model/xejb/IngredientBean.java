 ...
 * 	
 * @ejb:finder signature="Collection findByFavouriteFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM Ingredient o WHERE o._FavouriteFormula_oid = ?1 ORDER BY o.oid" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByFavouriteFormula(java.lang.String oid)" query="SELECT OBJECT(o) FROM Ingredient o WHERE o._FavouriteFormula_oid = ?1 ORDER BY o.oid" 	
...
abstract public class IngredientBean extends EJBReplicableBase 
	...
	// FavouriteFormula : Entity reference/Referencia a entidad
	...
	public org.openxava.test.model.IFormula getFavouriteFormula() {
		try {		
			return getFavouriteFormulaHome().findByPrimaryKey(getFavouriteFormulaKey());
		}
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("get_reference_error", "FavouriteFormula", "Ingredient"));
		}		
	}	
	...
	public org.openxava.test.model.FormulaRemote getFavouriteFormulaRemote() {
		return (org.openxava.test.model.FormulaRemote) getFavouriteFormula();
	}
	...
	public void setFavouriteFormula(org.openxava.test.model.IFormula newFavouriteFormula) { 
		this.modified = true; 
		try {	
			if (newFavouriteFormula == null) setFavouriteFormulaKey(null);
			else {
				if (newFavouriteFormula instanceof org.openxava.test.model.Formula) {
					throw new IllegalArgumentException(XavaResources.getString("pojo_to_ejb_illegal"));
				}
				org.openxava.test.model.FormulaRemote remote = (org.openxava.test.model.FormulaRemote) newFavouriteFormula;
				setFavouriteFormulaKey((org.openxava.test.model.FormulaKey) remote.getPrimaryKey());
			}	
		}
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("set_reference_error", "FavouriteFormula", "Ingredient"));
		}
	}
	...
	public org.openxava.test.model.FormulaKey getFavouriteFormulaKey() {				
		...
		key.oid = getFavouriteFormula_oid();		
		return key;
	}	
	...
	public void setFavouriteFormulaKey(org.openxava.test.model.FormulaKey key) { 
		...
		if (key == null) {
			...
			setFavouriteFormula_oid(key.oid);					
		}
		else { 
			setFavouriteFormula_oid(key.oid);		
		}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "FAVOURITEFORMULA"
	 */
	public abstract String get_FavouriteFormula_oid();
	public abstract void set_FavouriteFormula_oid(String newFavouriteFormula_oid);

	/**		
	 * @ejb:interface-method
	 * @ejb.value-object match="persistentCalculatedAndAggregate"
	 */
	public String getFavouriteFormula_oid() { 
		return get_FavouriteFormula_oid(); 
	}
	public void setFavouriteFormula_oid(String newFavouriteFormula_oid) { 
		set_FavouriteFormula_oid(newFavouriteFormula_oid); 	
	} 

	private org.openxava.test.model.FormulaHome favouriteFormulaHome;	
	private org.openxava.test.model.FormulaHome getFavouriteFormulaHome() throws Exception{
		if (favouriteFormulaHome == null) {
			favouriteFormulaHome = (org.openxava.test.model.FormulaHome) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.model/Formula"),
			 		org.openxava.test.model.FormulaHome.class);			 		
		}
		return favouriteFormulaHome;
	} 
