...
abstract public class CourseBean extends EJBReplicableBase 
	...
	public org.openxava.test.model.CourseKey ejbCreate(Map values) 
		...
		executeSets(values); 
		try { 	
			org.openxava.calculators.StringCalculator dtypeCalculator = (org.openxava.calculators.StringCalculator)
				getMetaModel().getMetaProperty("dtype").getMetaCalculatorDefaultValue().createCalculator(); 
			setDtype((String) dtypeCalculator.calculate()); 	
	...
	private org.openxava.converters.IConverter getDtypeConverter() {
		if (dtypeConverter == null) {
			try {
				...
				ex.printStackTrace();
				throw new EJBException(XavaResources.getString("generator.create_converter_error", "dtype"));
			}
	 ...
	 * @ejb:persistent-field
	 * 
	 * @jboss:column-name "DTYPE"
	 */
	public abstract java.lang.String get_Dtype();
	public abstract void set_Dtype(java.lang.String newDtype); 	
	...
	public String getDtype() {
		try {
			...
			ex.printStackTrace();
			throw new EJBException(XavaResources.getString("generator.conversion_error", "Dtype", "Course", "String"));
		}
	}
