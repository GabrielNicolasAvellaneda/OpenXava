 ...
 * @ejb:finder signature="Collection findByPreferredWarehouse(int zoneNumber, java.lang.Integer number)" query="SELECT OBJECT(o) FROM DeliveryPlace o WHERE o._PreferredWarehouse_zoneNumber = ?1 AND o._PreferredWarehouse_number = ?2 " view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByPreferredWarehouse(int zoneNumber, java.lang.Integer number)" query="SELECT OBJECT(o) FROM DeliveryPlace o WHERE o._PreferredWarehouse_zoneNumber = ?1 AND o._PreferredWarehouse_number = ?2 " 
 * 
