...
// File generated by OpenXava: Thu May 08 21:37:00 CEST 2014
// Archivo generado por OpenXava: Thu May 08 21:37:00 CEST 2014
	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Collection findAll()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Invoice as o where 1 = 1"); 
 	...
 	public static Collection findPaidOnes()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Invoice as o where o.paid = 'S'"); 
 			return query.getResultList();  		
 		}
 		else {
 	...
 	public static Invoice findByYearNumber(int year,int number) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Invoice as o where o.year = :arg0 and number = :arg1"); 
