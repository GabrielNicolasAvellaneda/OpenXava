	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static AverageSpeed findByOid(java.lang.String oid) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from AverageSpeed as o where o.oid = :arg0"); 
			query.setParameter("arg0", oid); 
 			try {
				return (AverageSpeed) query.getSingleResult();
			}
			catch (Exception ex) {
