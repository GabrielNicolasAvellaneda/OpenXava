...
// File generated by OpenXava: Thu May 08 18:50:43 CEST 2014
// Archivo generado por OpenXava: Thu May 08 18:50:43 CEST 2014

// WARNING: NO EDIT
// OJO: NO EDITAR
// Component: Seller2		Entity/Entidad
 ...
 */
public class Seller2 implements java.io.Serializable, org.openxava.test.model.ISeller2 {	
	...
	public String getName() {
		try {
			...
			ex.printStackTrace();
			throw new RuntimeException(XavaResources.getString("generator.conversion_error", "Name", "Seller2", "String"));
		}
	}
	...
	public String [] getRegions() {
		try {
			...
			ex.printStackTrace();
			throw new RuntimeException(XavaResources.getString("generator.conversion_error", "Regions", "Seller2", "String []"));
		}
	}
	...
	public void addToCustomers(org.openxava.test.model.ICustomer2 newElement) throws RemoteException {
		this.getCustomers().add(newElement);
		newElement.setSeller(this);
	}
	public void removeFromCustomers(org.openxava.test.model.ICustomer2 toRemove) throws RemoteException {
	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Collection findAll()  {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Seller2 as o where 1 = 1"); 
 			return query.getResultList();  		
 		}
 		else {
 			org.hibernate.Query query = org.openxava.hibernate.XHibernate.getSession().createQuery("from Seller2 as o where 1 = 1"); 
 			org.hibernate.Query sizeQuery = org.openxava.hibernate.XHibernate.getSession().createQuery("select count(*) from Seller2 as o where 1 = 1"); 
 			return new org.openxava.hibernate.impl.FastSizeList(query, sizeQuery); 
 		}
 	} 	
 	public static Seller2 findByNumber(int number) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Seller2 as o where o.number = :arg0"); 
			query.setParameter("arg0", new Integer(number)); 
 			try {
				return (Seller2) query.getSingleResult();
			}
			catch (Exception ex) {
				// In this way in order to work with Java pre 5 
				if (ex.getClass().getName().equals("javax.persistence.NoResultException")) {
					throw new javax.ejb.ObjectNotFoundException(XavaResources.getString("object_not_found", "Seller2"));
				}
				else {
					ex.printStackTrace();
 			...
 			org.hibernate.Query query = org.openxava.hibernate.XHibernate.getSession().createQuery("from Seller2 as o where o.number = :arg0"); 
			query.setParameter("arg0", new Integer(number)); 
			Seller2 r = (Seller2) query.uniqueResult();
			if (r == null) {
				throw new javax.ejb.ObjectNotFoundException(XavaResources.getString("object_not_found", "Seller2"));
			}
			return r; 
	...
	public MetaModel getMetaModel() throws XavaException {
		if (metaModel == null) {
			metaModel = MetaComponent.get("Seller2").getMetaEntity(); 	
		}
		return metaModel;
	}
	...
	public String toString() {		
		try {
			...
			System.err.println(XavaResources.getString("toString_warning", "Seller2"));
