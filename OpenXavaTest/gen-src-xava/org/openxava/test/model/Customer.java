...
public class Customer implements java.io.Serializable, org.openxava.test.model.ICustomer {	
	...
	public boolean isLocal() {
		try { 		
			org.openxava.test.calculators.IsLocalCustomerCalculator localCalculator= (org.openxava.test.calculators.IsLocalCustomerCalculator)
				getMetaModel().getMetaProperty("local").getMetaCalculator().getCalculator();  	
	...
	private org.openxava.converters.IConverter relationWithSellerConverter;
	...
	private org.openxava.converters.IConverter photoConverter;
	...
	private org.openxava.converters.IConverter address_zipCodeConverter;
	...
	private org.openxava.converters.IConverter address_streetConverter;
	...
	public String getAddress_asString() {
		try { 		
			org.openxava.calculators.ConcatCalculator address_asStringCalculator= (org.openxava.calculators.ConcatCalculator)
				getMetaModel().getMetaProperty("address.asString").getMetaCalculator().getCalculator();  	
	...
	private org.openxava.converters.IConverter address_cityConverter;
	...
	public void calculateShippingAndHandling()  {
		try { 		
			org.openxava.test.calculators.ShippingAndHandlingCalculator calculateShippingAndHandlingCalculator = (org.openxava.test.calculators.ShippingAndHandlingCalculator)
				getMetaModel().getMetaMethod("calculateShippingAndHandling").getMetaCalculator().getCalculator();  	
	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Customer findByNumber(int number) {
 	...
 	public static Collection findByNameLike(java.lang.String name) {
 		...
 		org.hibernate.Query sizeQuery = org.openxava.hibernate.XHibernate.getSession().createQuery("select count(*) from Customer as o where o.name like :arg0 order by o.name desc"); 
		query.setParameter("arg0", name); 
		sizeQuery.setParameter("arg0", name); 
 		return new org.openxava.hibernate.FastSizeList(query, sizeQuery);
 	} 	
 	public static Collection findByNameLikeAndrelationWithSeller(java.lang.String name, java.lang.String relationWithSeller) {
 		org.hibernate.Query query = org.openxava.hibernate.XHibernate.getSession().createQuery("from Customer as o where o.name like :arg0 and o.relationWithSeller = :arg1 order by o.name desc"); 
 		org.hibernate.Query sizeQuery = org.openxava.hibernate.XHibernate.getSession().createQuery("select count(*) from Customer as o where o.name like :arg0 and o.relationWithSeller = :arg1 order by o.name desc"); 
		query.setParameter("arg0", name); 
		sizeQuery.setParameter("arg0", name); 
 	...
 	public static Collection findByStreet(java.lang.String street) {
 		org.hibernate.Query query = org.openxava.hibernate.XHibernate.getSession().createQuery("from Customer as o where o.address.street = :arg0"); 
 		org.hibernate.Query sizeQuery = org.openxava.hibernate.XHibernate.getSession().createQuery("select count(*) from Customer as o where o.address.street = :arg0"); 
