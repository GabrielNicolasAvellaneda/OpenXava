	...
	// User defined finders/Buscadores definidos por el usuario 	
 	public static Family2 findByNumber(int number) throws javax.ejb.ObjectNotFoundException {
 		if (XavaPreferences.getInstance().isJPAPersistence()) { 			
 			javax.persistence.Query query = org.openxava.jpa.XPersistence.getManager().createQuery("from Family2 as o where o.number = :arg0"); 
			query.setParameter("arg0", new Integer(number)); 
 			try {
				return (Family2) query.getSingleResult();
			}
			catch (Exception ex) {
