...
abstract public class OfficeBean extends EJBReplicableBase 
	...
	public void setMainWarehouse(org.openxava.test.ejb.Warehouse newMainWarehouse) { 
		...
		try {	
			...
			else setMainWarehouseKey((org.openxava.test.ejb.WarehouseKey) newMainWarehouse.getPrimaryKey());
		}
		catch (Exception ex) {
			ex.printStackTrace();
	...
	private org.openxava.test.ejb.WarehouseHome getMainWarehouseHome() throws Exception{
		if (mainWarehouseHome == null) {
			mainWarehouseHome = (org.openxava.test.ejb.WarehouseHome) PortableRemoteObject.narrow(
