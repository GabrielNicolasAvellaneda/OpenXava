...
/**
 * @ejb:bean name="Office" type="CMP" jndi-name="@subcontext@/ejb/org.openxava.test.ejb/Office" reentrant="false" view-type="remote"
 * @ejb:interface extends="org.openxava.ejbx.EJBReplicable, org.openxava.test.ejb.IOffice"
 ...
 * 	
 * @ejb:finder signature="Collection findByOfficeManager(int officeNumber, int number, int zoneNumber)" query="SELECT OBJECT(o) FROM Office o WHERE o.number = ?1 AND o.officeManager_number = ?2 AND o._ZoneNumber = ?3" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByOfficeManager(int officeNumber, int number, int zoneNumber)" query="SELECT OBJECT(o) FROM Office o WHERE o.number = ?1 AND o.officeManager_number = ?2 AND o._ZoneNumber = ?3 " 	
 * @ejb:finder signature="Collection findByDefaultCarrier(java.lang.Integer number)" query="SELECT OBJECT(o) FROM Office o WHERE o.defaultCarrier_number = ?1" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByDefaultCarrier(java.lang.Integer number)" query="SELECT OBJECT(o) FROM Office o WHERE o.defaultCarrier_number = ?1 " 	
 * @ejb:finder signature="Collection findByMainWarehouse(java.lang.Integer number, int zoneNumber)" query="SELECT OBJECT(o) FROM Office o WHERE o.mainWarehouse_number = ?1 AND o._ZoneNumber = ?2" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByMainWarehouse(java.lang.Integer number, int zoneNumber)" query="SELECT OBJECT(o) FROM Office o WHERE o.mainWarehouse_number = ?1 AND o._ZoneNumber = ?2 " 
 * 
 * @jboss:table-name "XAVATEST@separator@OFFICE"
 *
 * @author Javier Paniza
 */
abstract public class OfficeBean extends EJBReplicableBase 
			implements org.openxava.test.ejb.IOffice, EntityBean {	
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.ejb.OfficeKey ejbCreate(Map values) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.ejb.OfficeKey ejbCreate(org.openxava.test.ejb.OfficeData data) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.openxava.test.ejb.OfficeData data) 
		throws
			CreateException,
			ValidationException {			
	}
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.ejb.OfficeKey ejbCreate(org.openxava.test.ejb.OfficeValue value) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.openxava.test.ejb.OfficeValue value) 
		throws
			CreateException,
			ValidationException {			
	}
	...
	public void setOfficeManager(org.openxava.test.ejb.Clerk newOfficeManager) {
		try {	
			...
			else setOfficeManagerKey((org.openxava.test.ejb.ClerkKey) newOfficeManager.getPrimaryKey());
		}
		catch (Exception ex) {
			ex.printStackTrace();
	...
	private org.openxava.test.ejb.ClerkHome getOfficeManagerHome() throws Exception{
		if (officeManagerHome == null) {
			officeManagerHome = (org.openxava.test.ejb.ClerkHome) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.ejb/Clerk"),
			 		org.openxava.test.ejb.ClerkHome.class);			 		
		}
	...
	public void setDefaultCarrier(org.openxava.test.ejb.Carrier newDefaultCarrier) {
		try {	
			...
			else setDefaultCarrierKey((org.openxava.test.ejb.CarrierKey) newDefaultCarrier.getPrimaryKey());
		}
		catch (Exception ex) {
			ex.printStackTrace();
	...
	private org.openxava.test.ejb.CarrierHome getDefaultCarrierHome() throws Exception{
		if (defaultCarrierHome == null) {
			defaultCarrierHome = (org.openxava.test.ejb.CarrierHome) PortableRemoteObject.narrow(
	...
	public void setMainWarehouse(org.openxava.test.ejb.Warehouse2 newMainWarehouse) {
		try {	
			...
			else setMainWarehouseKey((org.openxava.test.ejb.Warehouse2Key) newMainWarehouse.getPrimaryKey());
		}
		catch (Exception ex) {
			ex.printStackTrace();
	...
	private org.openxava.test.ejb.Warehouse2Home mainWarehouseHome;	
	private org.openxava.test.ejb.Warehouse2Home getMainWarehouseHome() throws Exception{
		if (mainWarehouseHome == null) {
			mainWarehouseHome = (org.openxava.test.ejb.Warehouse2Home) PortableRemoteObject.narrow(
	 ...
	 * @ejb:interface-method
	 */	
	public abstract org.openxava.test.ejb.OfficeData getData();		
	
	/**
	 * @ejb:interface-method
	 */		
	public abstract void setData(org.openxava.test.ejb.OfficeData data);
	
	/**
	 * @ejb:interface-method
	 */	
	public abstract org.openxava.test.ejb.OfficeValue getOfficeValue();		
	
	/**
	 * @ejb:interface-method
	 */		
	public abstract void setOfficeValue(org.openxava.test.ejb.OfficeValue value);
