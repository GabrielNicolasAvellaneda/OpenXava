 ...
 * @ejb:finder signature="Collection findByShipment(java.lang.Integer type, int mode, int number)" query="SELECT OBJECT(o) FROM Delivery o WHERE o.shipment_type = ?1 AND o.shipment_mode = ?2 AND o.shipment_number = ?3" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByShipment(java.lang.Integer type, int mode, int number)" query="SELECT OBJECT(o) FROM Delivery o WHERE o.shipment_type = ?1 AND o.shipment_mode = ?2 AND o.shipment_number = ?3 " 	
...
abstract public class DeliveryBean extends EJBReplicableBase 
	...
	public abstract void setShipment_type(java.lang.Integer newShipment_type);
	/**		
	 * @ejb:interface-method
	 * @ejb:persistent-field
	 * 
