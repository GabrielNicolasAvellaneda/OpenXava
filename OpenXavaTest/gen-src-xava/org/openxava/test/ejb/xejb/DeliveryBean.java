 ...
 * @ejb:finder signature="Collection findByShipment(java.lang.Integer type, int number)" query="SELECT OBJECT(o) FROM Delivery o WHERE o.shipment_type = ?1 AND o.shipment_number = ?2" view-type="remote" result-type-mapping="Remote"
 * @jboss:query signature="Collection findByShipment(java.lang.Integer type, int number)" query="SELECT OBJECT(o) FROM Delivery o WHERE o.shipment_type = ?1 AND o.shipment_number = ?2 " 	
