...
abstract public class InvoiceBean extends EJBReplicableBase 
			implements org.openxava.test.ejb.IInvoice, EntityBean {	
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.ejb.InvoiceKey ejbCreate(Map values) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.ejb.InvoiceKey ejbCreate(org.openxava.test.ejb.InvoiceData data) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.openxava.test.ejb.InvoiceData data) 
		throws
			CreateException,
			ValidationException {			
	}
	 ...
	 * @ejb:create-method
	 */	 
	public org.openxava.test.ejb.InvoiceKey ejbCreate(org.openxava.test.ejb.InvoiceValue value) 
		throws
			CreateException,
			ValidationException {
		initMembers();	
	...
	public void ejbPostCreate(org.openxava.test.ejb.InvoiceValue value) 
		throws
			CreateException,
			ValidationException {			
	}
	...
	/**
	  * @ejb:interface-method
	  */
	public abstract void setDate(java.util.Date newDate); 
	...
	private org.openxava.test.ejb.InvoiceDetailHome getDetailsHome() throws Exception{
		if (detailsHome == null) {
			detailsHome = (org.openxava.test.ejb.InvoiceDetailHome) PortableRemoteObject.narrow(
			 		BeansContext.get().lookup("ejb/org.openxava.test.ejb/InvoiceDetail"),
			 		org.openxava.test.ejb.InvoiceDetailHome.class);			 		
		}
		return detailsHome;
	}	
	...
	private org.openxava.test.ejb.DeliveryHome getDeliveriesHome() throws Exception{
		if (deliveriesHome == null) {
			deliveriesHome = (org.openxava.test.ejb.DeliveryHome) PortableRemoteObject.narrow(
