...
abstract public class DeliveryPlaceBean extends EJBReplicableBase 
	...
	public void setPreferredWarehouse(org.openxava.test.ejb.Warehouse2 newPreferredWarehouse) {
		try {	
			...
			else setPreferredWarehouseKey((org.openxava.test.ejb.Warehouse2Key) newPreferredWarehouse.getPrimaryKey());
		}
		catch (Exception ex) {
			ex.printStackTrace();
	...
	private org.openxava.test.ejb.Warehouse2Home preferredWarehouseHome;	
	private org.openxava.test.ejb.Warehouse2Home getPreferredWarehouseHome() throws Exception{
		if (preferredWarehouseHome == null) {
			preferredWarehouseHome = (org.openxava.test.ejb.Warehouse2Home) PortableRemoteObject.narrow(
