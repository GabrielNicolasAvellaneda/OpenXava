 ...
 * @autor Ana Andrés
 */
public class OnChangeGroupInColor extends OnChangePropertyBaseAction implements IChangeControllersAction{
	private static Log log = LogFactory.getLog(OnChangeGroupInColor.class);
	...
	public String[] getNextControllers() throws Exception {
		return 
			...
			(group == Color.Group.GROUP2 ? new String [] {"ActionWhitImage"} :
			new String [] {});
	}
