...
while (it.hasNext()) {
	...
	if (!property.isCalculated()) {
		...
		String editorURLDescriptionsList = WebEditors.getEditorURLDescriptionsList(tab.getModelName(), Ids.decorate(request, property.getQualifiedName()), iConditionValues, prefix, property.getQualifiedName(), property.getName());
