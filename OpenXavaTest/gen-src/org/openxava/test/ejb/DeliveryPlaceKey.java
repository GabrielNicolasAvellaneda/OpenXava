   ...
   implements java.io.Serializable
{
   ...
   {
      if( !(obj instanceof org.openxava.test.ejb.DeliveryPlaceKey) )
         return false;

      org.openxava.test.ejb.DeliveryPlaceKey pk = (org.openxava.test.ejb.DeliveryPlaceKey)obj;
      boolean eq = true;
    ...
    */
   public DeliveryPlaceKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
