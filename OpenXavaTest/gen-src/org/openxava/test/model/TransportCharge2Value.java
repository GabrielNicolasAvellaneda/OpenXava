   ...
   implements java.io.Serializable 
{
   ...
   public String toString()
   {
	  ...
	  str.append("amount=" + getAmount() + " " + "year=" + getYear() + " " + "delivery_number=" + getDelivery_number() + " " + "delivery_type_number=" + getDelivery_type_number() + " " + "delivery_invoice_year=" + getDelivery_invoice_year() + " " + "delivery_invoice_number=" + getDelivery_invoice_number());
	  str.append('}');
