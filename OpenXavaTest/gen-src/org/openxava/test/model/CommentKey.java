   ...
   implements java.io.Serializable
{
   ...
   public CommentKey( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.CommentKey) )
         return false;

      org.openxava.test.model.CommentKey pk = (org.openxava.test.model.CommentKey)obj;
      boolean eq = true;
    ...
    */
   public static CommentKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
