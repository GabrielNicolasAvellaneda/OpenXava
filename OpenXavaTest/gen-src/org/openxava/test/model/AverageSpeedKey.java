   ...
   implements java.io.Serializable
{
   ...
   public AverageSpeedKey()
   {
   }

   public AverageSpeedKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.AverageSpeedKey) )
         return false;

      org.openxava.test.model.AverageSpeedKey pk = (org.openxava.test.model.AverageSpeedKey)obj;
      boolean eq = true;
    ...
    */
   public static AverageSpeedKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
      StringTokenizer st = new StringTokenizer(string, "[.]");
      AverageSpeedKey key = new AverageSpeedKey();
