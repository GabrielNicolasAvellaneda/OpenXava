   ...
   implements java.io.Serializable
{
   ...
   public Invoice2Key( int number,int year )
   {
      this.number = number;
      this.year = year;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.Invoice2Key) )
         return false;

      org.openxava.test.model.Invoice2Key pk = (org.openxava.test.model.Invoice2Key)obj;
      boolean eq = true;
    ...
    */
   public static Invoice2Key createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
      StringTokenizer st = new StringTokenizer(string, "[.]");
      Invoice2Key key = new Invoice2Key();
