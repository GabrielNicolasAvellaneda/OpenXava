   ...
   implements java.io.Serializable
{
   ...
   public RangesKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.RangesKey) )
         return false;

      org.openxava.test.model.RangesKey pk = (org.openxava.test.model.RangesKey)obj;
      boolean eq = true;
    ...
    */
   public static RangesKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
      StringTokenizer st = new StringTokenizer(string, "[.]");
      RangesKey key = new RangesKey();
