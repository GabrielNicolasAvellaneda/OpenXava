   ...
   implements java.io.Serializable
{
   ...
   public OrderKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.OrderKey) )
         return false;

      org.openxava.test.model.OrderKey pk = (org.openxava.test.model.OrderKey)obj;
      boolean eq = true;
    ...
    */
   public static OrderKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
