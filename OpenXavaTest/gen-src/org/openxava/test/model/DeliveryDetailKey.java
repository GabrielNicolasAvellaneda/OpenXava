   ...
   implements java.io.Serializable
{
   ...
   {
      if( !(obj instanceof org.openxava.test.model.DeliveryDetailKey) )
         return false;

      org.openxava.test.model.DeliveryDetailKey pk = (org.openxava.test.model.DeliveryDetailKey)obj;
      boolean eq = true;
    ...
    */
   public static DeliveryDetailKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
      StringTokenizer st = new StringTokenizer(string, "[.]");
      DeliveryDetailKey key = new DeliveryDetailKey();
