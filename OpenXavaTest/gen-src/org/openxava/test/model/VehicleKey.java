   ...
   implements java.io.Serializable
{
   ...
   public VehicleKey( java.lang.String oid )
   {
      this.oid = oid;
   }
   ...
   {
      if( !(obj instanceof org.openxava.test.model.VehicleKey) )
         return false;

      org.openxava.test.model.VehicleKey pk = (org.openxava.test.model.VehicleKey)obj;
      boolean eq = true;
    ...
    */
   public static VehicleKey createFromString(String string) throws IllegalArgumentException, IllegalAccessException {
